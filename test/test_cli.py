...
"""
    ...
    def test_generate_nonexistent_source(self):
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            result = runner.invoke(
                app, ["generate", str(nonexistent), "--output", str(output_dir)]
            )
...
class TestTemplatesCommand:
    ...
    def test_templates_list_success(self):
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            result = runner.invoke(
                app, ["templates", "--template-dir", str(template_dir)]
            )
    ...
    def test_templates_list_error(self):
        ...
        result = runner.invoke(
            app, ["templates", "--template-dir", "/definitely/nonexistent/directory"]
        )
...
class TestValidateCommand:
    ...
    def test_validate_success(self):
        ...
        result = runner.invoke(app, ["validate", "python/default/module.md.jinja2"])
    ...
    def test_validate_nonexistent_template(self):
        ...
        result = runner.invoke(app, ["validate", "nonexistent/template.jinja2"])
...
class TestWatchCommand:
    ...
    def test_watch_nonexistent_directory(self):
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            result = runner.invoke(
                app, ["watch", str(nonexistent_dir), "--output", str(output_dir)]
            )
