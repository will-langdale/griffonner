...
from griffonner.plugins.manager import PluginManager, PluginError, PluginLoadError
from griffonner.plugins.base import BaseProcessor, BaseBundle, SimpleProcessor
...
class TestPluginManager:
    ...
    def test_load_plugin_error(self, mock_entry_points):
        ...
        with pytest.raises(PluginLoadError, match="Failed to load plugin 'broken_processor'"):
            manager.load_plugins()
